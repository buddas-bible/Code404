...
namespace Code404
{
	...
	const float MELEE_A_DAMAGE = 50.0f;
	const float MELEE_A_HP = 100.0f;
	const float MELEE_A_PATROL_SPEED = 50.f;
	const float MELEE_A_TRACE_SPEED = 100.f;
	const float MELEE_A_ATTACK_DELAY = 4.f;
	
	const float MELEE_B_DAMAGE = 20.0f;
	const float MELEE_B_HP = 200.0f;
	...
	const float RANGE_B_DAMAGE = 40.0f;
	const float RANGE_B_HP = 200.0f;
	const float RANGE_B_PATROL_SPEED = 50.f;
	const float RANGE_B_TRACE_SPEED = 100.f;
	const float RANGE_B_ATTACK_DELAY = 4.f;
	const float RANGE_B_BULLET_SPEED = 1000.f;

	const float BOSS_HEAD_MAX_HP = 400.f;
	const float BOSS_HAND_MAX_HP = 200.f;
	const float BOSS_NORMAL_BULLET_DAMAGE = 50.f;
	const float BOSS_TRACE_BULLET_DAMAGE = 50.f;
	const float BOSS_CROSS_LASER_DAMAGE = 50.f;
	const float BOSS_PATROL_LASER_DAMAGE = 50.f;
	const float BOSS_TIME_LASER_DAMAGE = 50.f;
